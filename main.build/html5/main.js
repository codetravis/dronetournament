...
c_DroneTournamentGame.prototype.p_OnCreate=function(){
	push_err();
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/main.monkey<9>";
	print("Creating Game");
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/main.monkey<10>";
	bb_app_SetUpdateRate(60);
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/main.monkey<11>";
	this.m_player=c_Player.m_new.call(new c_Player,150.0,150.0,-30.0,100.0,3.0);
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/main.monkey<12>";
	this.m_moves=0;
	pop_err();
	return 0;
}
c_DroneTournamentGame.prototype.p_OnUpdate=function(){
	...
	if(this.m_moves<1){
		...
		if((bb_input_TouchDown(0))!=0){
			err_info="/Users/tcooper/projects/monkeygames/dronetournament/main.monkey<18>";
			this.m_player.p_SetControl(bb_input_TouchX(0),bb_input_TouchY(0));
			err_info="/Users/tcooper/projects/monkeygames/dronetournament/main.monkey<19>";
			this.m_player.p_UpdateLine();
		}
...
function c_Player(){
	...
	this.m_moveXPoints=null;
	this.m_moveYPoints=null;
	this.m_Points=null;
}
c_Player.prototype.p_SetMovePoints=function(t_new_rotation){
	push_err();
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<71>";
	this.m_moveXPoints=bb_dronetournament_CubicHermite(dbg_object(this.m_position).m_x,dbg_object(dbg_object(this.m_control).m_position).m_x,dbg_object(this.m_velocity).m_x,this.m_maxVelocity*Math.cos(t_new_rotation*0.017453292500000002));
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<72>";
	this.m_moveYPoints=bb_dronetournament_CubicHermite(dbg_object(this.m_position).m_y,dbg_object(dbg_object(this.m_control).m_position).m_y,dbg_object(this.m_velocity).m_y,this.m_maxVelocity*Math.sin(t_new_rotation*0.017453292500000002));
	pop_err();
	return 0;
}
c_Player.prototype.p_SetControl=function(t_click_x,t_click_y){
	push_err();
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<77>";
	...
	var t_start_angle=((this.m_heading)|0);
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<79>";
	var t_control_pos=c_Vec2D.m_new.call(new c_Vec2D,dbg_object(this.m_position).m_x,dbg_object(this.m_position).m_y);
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<80>";
	this.m_Points=c_Deque2.m_new.call(new c_Deque2);
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<82>";
	for(var t_i=0;t_i<30;t_i=t_i+1){
		...
		if(t_start_angle>t_goal_angle){
			...
			t_start_angle=(((t_start_angle)-this.m_maxRotation)|0);
		}else{
		...
		this.m_Points.p_PushLast2(t_control_pos);
	}
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<92>";
	dbg_object(this.m_control).m_position.p_Set(dbg_object(t_control_pos).m_x,dbg_object(t_control_pos).m_y);
	pop_err();
	return 0;
}
c_Player.m_new=function(t_x,t_y,t_initial_heading,t_max_velocity_limit,t_rotationLimit){
	push_err();
	...
	this.m_control=c_ControlPoint.m_new.call(new c_ControlPoint,t_x+t_max_velocity_limit,t_y);
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<36>";
	this.m_maxVelocity=t_max_velocity_limit;
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<37>";
	this.m_maxRotation=t_rotationLimit;
	...
	this.m_velocity=c_Vec2D.m_new.call(new c_Vec2D,this.m_maxVelocity*Math.cos(this.m_heading*0.017453292500000002),this.m_maxVelocity*Math.sin(this.m_heading*0.017453292500000002));
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<40>";
	this.p_SetMovePoints(this.m_heading);
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<41>";
	this.p_SetControl(dbg_object(this.m_velocity).m_x,dbg_object(this.m_velocity).m_y);
	pop_err();
	return this;
}
...
c_Player.prototype.p_UpdateLine=function(){
	push_err();
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<66>";
	var t_angle=((Math.atan2(dbg_object(dbg_object(this.m_control).m_position).m_y-dbg_object(this.m_position).m_y,dbg_object(dbg_object(this.m_control).m_position).m_x-dbg_object(this.m_position).m_x)*R2D)|0);
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<67>";
	this.p_SetMovePoints(t_angle);
	pop_err();
	return 0;
}
c_Player.prototype.p_Update=function(){
	push_err();
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<58>";
	...
	this.m_velocity.p_Set(this.m_maxVelocity*Math.cos(this.m_heading*0.017453292500000002),this.m_maxVelocity*Math.sin(this.m_heading*0.017453292500000002));
...
c_Player.prototype.p_DrawStatic=function(){
	...
	bb_graphics_DrawRect(dbg_object(this.m_position).m_x,dbg_object(this.m_position).m_y,15.0,15.0);
	...
	for(var t_i=0;t_i<this.m_moveXPoints.p_Length()-1;t_i=t_i+1){
	...
	bb_graphics_DrawLine(dbg_object(this.m_position).m_x,dbg_object(this.m_position).m_y,dbg_object(this.m_position).m_x+dbg_object(this.m_velocity).m_x,dbg_object(this.m_position).m_y+dbg_object(this.m_velocity).m_y);
	pop_err();
	return 0;
}
function c_Vec2D(){
...
c_Vec2D.prototype.p_Set=function(t_x,t_y){
	push_err();
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<17>";
	dbg_object(this).m_x=t_x;
...
c_Vec2D.m_new=function(t_x,t_y){
	push_err();
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<13>";
	this.p_Set(t_x,t_y);
	pop_err();
	return this;
}
...
c_ControlPoint.m_new=function(t_x,t_y){
	push_err();
...
c_ControlPoint.prototype.p_Draw=function(){
	...
	bb_graphics_DrawRect(dbg_object(this.m_position).m_x,dbg_object(this.m_position).m_y,5.0,5.0);
	pop_err();
	return 0;
}
function c_Deque(){
	Object.call(this);
	this.m__data=new_number_array(4);
	this.m__capacity=0;
	this.m__last=0;
	this.m__first=0;
}
...
c_Deque.m_new2=function(t_arr){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<8>";
	this.m__data=t_arr.slice(0);
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<9>";
	this.m__capacity=this.m__data.length;
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<10>";
...
c_Deque.prototype.p_Length=function(){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<31>";
	...
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<32>";
...
c_Deque.prototype.p_Grow=function(){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<135>";
	var t_data=new_number_array(this.m__capacity*2+10);
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<136>";
	if(this.m__first<=this.m__last){
		err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<137>";
		for(var t_i=this.m__first;t_i<this.m__last;t_i=t_i+1){
			err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<138>";
			dbg_array(t_data,t_i-this.m__first)[dbg_index]=dbg_array(this.m__data,t_i)[dbg_index]
		}
		err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<140>";
		this.m__last-=this.m__first;
		err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<141>";
		this.m__first=0;
	}else{
		err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<143>";
		var t_n=this.m__capacity-this.m__first;
		err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<144>";
		for(var t_i2=0;t_i2<t_n;t_i2=t_i2+1){
			err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<145>";
			dbg_array(t_data,t_i2)[dbg_index]=dbg_array(this.m__data,this.m__first+t_i2)[dbg_index]
		}
		err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<147>";
		for(var t_i3=0;t_i3<this.m__last;t_i3=t_i3+1){
			err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<148>";
			dbg_array(t_data,t_n+t_i3)[dbg_index]=dbg_array(this.m__data,t_i3)[dbg_index]
		}
		err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<150>";
		this.m__last+=t_n;
		err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<151>";
		this.m__first=0;
	}
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<153>";
	this.m__capacity=t_data.length;
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<154>";
	this.m__data=t_data;
	pop_err();
}
c_Deque.prototype.p_PushLast=function(t_value){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<83>";
	if(this.p_Length()+1>=this.m__capacity){
		err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<83>";
		this.p_Grow();
	}
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<84>";
	dbg_array(this.m__data,this.m__last)[dbg_index]=t_value
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<85>";
	this.m__last+=1;
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<86>";
...
function c_FloatDeque(){
	c_Deque.call(this);
}
c_FloatDeque.prototype=extend_class(c_Deque);
c_FloatDeque.m_new=function(){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<194>";
	c_Deque.m_new.call(this);
	pop_err();
	return this;
}
c_FloatDeque.m_new2=function(t_data){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<198>";
	c_Deque.m_new2.call(this,t_data);
	pop_err();
	return this;
}
function bb_dronetournament_CubicHermite(t_start_point,t_end_point,t_start_velocity,t_end_velocity){
	push_err();
	err_info="/Users/tcooper/projects/monkeygames/dronetournament/dronetournament.monkey<111>";
	var t_pathPoints=c_FloatDeque.m_new.call(new c_FloatDeque);
...
c_Deque2.m_new=function(){
	push_err();
	pop_err();
	return this;
}
c_Deque2.m_new2=function(t_arr){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<8>";
	this.m__data=t_arr.slice(0);
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<9>";
...
c_Deque2.prototype.p_Length=function(){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<31>";
	if(this.m__last>=this.m__first){
		err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<31>";
...
c_Deque2.prototype.p_Grow=function(){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<135>";
...
c_Deque2.prototype.p_PushLast2=function(t_value){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<83>";
	if(this.p_Length()+1>=this.m__capacity){
		err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<83>";
...
c_Deque2.prototype.p_IsEmpty=function(){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<36>";
	var t_=this.m__first==this.m__last;
	pop_err();
	return t_;
}
c_Deque2.m_NIL=null;
c_Deque2.prototype.p_PopFirst=function(){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<91>";
	if(this.p_IsEmpty()){
		err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<91>";
		error("Illegal operation on empty deque");
	}
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<93>";
	var t_v=dbg_array(this.m__data,this.m__first)[dbg_index];
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<94>";
	dbg_array(this.m__data,this.m__first)[dbg_index]=c_Deque2.m_NIL
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<95>";
	this.m__first+=1;
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<96>";
	if(this.m__first==this.m__capacity){
		err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<96>";
		this.m__first=0;
	}
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<97>";
	pop_err();
	return t_v;
}
c_Deque2.prototype.p_Get=function(t_index){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<63>";
	if(t_index<0 || t_index>=this.p_Length()){
		err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<63>";
		error("Illegal deque index");
	}
	err_info="/Applications/MonkeyX77a/modules/monkey/deque.monkey<65>";
...
function bb_dronetournament_NewPoint(t_start_point,t_start_angle,t_goal_angle,t_max_angle_change,t_distance){
	...
	var t_=c_Vec2D.m_new.call(new c_Vec2D,dbg_object(t_start_point).m_x+t_distance*Math.cos(t_new_angle*0.017453292500000002),dbg_object(t_start_point).m_y+t_distance*Math.sin(t_new_angle*0.017453292500000002));
	pop_err();
	return t_;
}
function bb_input_TouchDown(t_index){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/mojo/input.monkey<80>";
...
function bb_graphics_DrawPoint(t_x,t_y){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/mojo/graphics.monkey<383>";
	bb_graphics_DebugRenderDevice();
	err_info="/Applications/MonkeyX77a/modules/mojo/graphics.monkey<385>";
	bb_graphics_context.p_Validate();
	err_info="/Applications/MonkeyX77a/modules/mojo/graphics.monkey<386>";
...
function bb_graphics_DrawLine(t_x1,t_y1,t_x2,t_y2){
	push_err();
	err_info="/Applications/MonkeyX77a/modules/mojo/graphics.monkey<399>";
	bb_graphics_DebugRenderDevice();
	err_info="/Applications/MonkeyX77a/modules/mojo/graphics.monkey<401>";
	bb_graphics_context.p_Validate();
	err_info="/Applications/MonkeyX77a/modules/mojo/graphics.monkey<402>";
